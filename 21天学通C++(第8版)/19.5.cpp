...
struct ContactItem
{
	...
	// used DisplayContents via count
...
int main()
{
	...
	setContacts.insert(ContactItem("Angi Merkel", "+47 23456 5466"));
	...
	cout << "Enter a name you with to delete: ";
	string inputName;
	...
	if(contactFound != setContacts.end())
	{
		...
		cout << "Displaying contects after erasing " << inputName << endl;
		DisplayContents(setContacts);
	}
	else
